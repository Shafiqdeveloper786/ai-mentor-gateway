...
export default function RegisterPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      // Redirect to OTP verification with context
  ...
  return (
    <main className="relative min-h-screen flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="w-full max-w-md">
        ...
        <AuthCard
          title="Create account to use AI Mentor"
          subtitle="Sign up and start learning with AI Mentor"
        >
          <form onSubmit={handleSubmit} noValidate>
            ...
            >
              <span className="relative z-10">
                {loading ? "SENDING OTP..." : "SIGN UP NOW"}
              </span>
            </button>
          </form>
          ...
          <p className="text-center text-[rgba(148,163,184,0.5)] text-sm mt-5 font-['Rajdhani']">
            ...
            <Link href="/auth/login" className="text-[#00d4ff] hover:text-[#00ff88] transition-colors font-semibold">
              Login
            </Link>
          </p>
        </AuthCard>
